...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq5(self):
        node = TextNode("This is a text node", TextType.BOLD, "http://www.somesite.com")
        node2 = TextNode("This is a text node", TextType.BOLD, "http://www.somesite.com")
        self.assertEqual(node, node2)

    def test_eq6(self):
        node = TextNode("This is a text node", TextType.BOLD, "http://www.somesite.com")
        node2 = TextNode("This is a text node", TextType.BOLD, "http://www.someothersite.com")
        self.assertNotEqual(node, node2)
